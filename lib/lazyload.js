/**
* Lazy Load allows images to be loaded asyncronously from the normal flow of the page.
* Images src is set on data-src (to be updated to make it configurable)
*
*@class LazyLoad
*@constructor Init //Singleton to only run one copy of the code.
*@param {String} class to identify elements on the DOM that are set for lazyload.
*@param {String} parameter set on image tag containing the correct image to load.
*/
